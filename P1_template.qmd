...
# print(mackenzie_df)
# (ggplot(mackenzie_df, mapping=aes(x="year", y="Total")) + geom_point())


(ggplot(mackenzie_df, aes(x="year", y="Total")) +
    geom_point() +
    geom_line(color="blue", size=1) +
    scale_x_continuous(limits=[1900, 2015], breaks=range(1900, 2021, 15)) +
    labs(
...
biblical_df = df.query('Entity in @names and Year >= 1920 and Year <= 2000')

p = (ggplot(names_df, aes(x="Code", y="Count", color="Entity")) +
     geom_line(size=1) +
     scale_x_continuous(limits=[1920, 2000], breaks=range(1920, 2001, 10)) +
     labs(title="Name Popularity of Mary, Martha, Peter, and Paul (1920-2000)",
